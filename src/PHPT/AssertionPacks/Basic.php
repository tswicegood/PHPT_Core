...
class PHPT_AssertionPacks_Basic
{
    ...
    {
        $assertion = new PHPT_Assert_True($value, $message = null);
    ...
    {
        $this->_record(
            new PHPT_Assert_False($value, $message = null)
        );
    }
    
    public function assertNull($value, $message = null)
    {
        $this->_record(new PHPT_Assert_Null($value, $message));
    }
    
    public function assertType($type, $value, $message = null)
    {
        $this->_record(new PHPT_Assert_Type($type, $value, $message));
    }
    
    public function assertEqual($one, $two, $message = null)
    {
        $this->_record(new PHPT_Assert_Equal($one, $two, $message));
    }
    
    public function assertNotEqual($one, $two, $message = null)
    {
        $this->_record(new PHPT_Assert_NotEqual($one, $two, $message));
    }
    
    public function assertIdentical($one, $two, $message = null)
    {
        $this->_record(new PHPT_Assert_Identical($one, $two, $message));
    }
    
    public function assertNotIdentical($one, $two, $message = null)
    {
        $this->_record(new PHPT_Assert_NotIdentical($one, $two, $message));
    }
    
    public function assertRegExp($pattern, $value, $message = null)
    {
        $this->_record(new PHPT_Assert_RegExp($pattern, $value, $message));
    }
    
    public function assertNotRegExp($pattern, $value, $message = null)
    {
        $this->_record(new PHPT_Assert_NotRegExp($pattern, $value, $message));
    }
    
    private function _record(PHPT_Assertion $assertion)
    {
