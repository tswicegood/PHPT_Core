--TEST--
When PHPT_Section_EXPECTF_UnexpectedOutputException is instantiated, it creates
...
$exception = new PHPT_Section_EXPECTF_UnexpectedOutputException($case, 'foobar');
